...
gulp.task('concatJs', function () {
    return gulp.src([src + '/libs/js/jquery.min.js', src + '/libs/js/jquery-ui.min.js', src + '/libs/js/jquery.touchSwipe.min.js', src + '/libs/js/slick.min.js', src + '/libs/js/core.js', src + '/libs/js/charts.js', src + '/libs/js/animated.js', src +'/libs/js/datepicker.min.js'])
        .pipe(sourcemaps.init())
