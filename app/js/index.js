$(document).ready(function () {
  let base_path = $('meta[name="base_asset_path"]').attr('content');
  ...
  $('.js-item-pay').click(function (e) {
    $('.js-item-pay').each(function (ind, el) {
      ...
      $(el).find('img').replaceWith(`<img src="./img/${atr}-black.png", alt="">`)
    })
    if ($(this).hasClass('active')) {
      var attr = $(this).attr('data-pay');
      $(this).removeClass('active');
      $(this).find('img').replaceWith(`<img src="./img/${attr}-black.png", alt="">`)
      ...
      $(this).addClass('active');
      var attr = $(this).attr('data-pay');
      $(this).find('img').replaceWith(`<img src="./img/${attr}-blue.png", alt="">`)
